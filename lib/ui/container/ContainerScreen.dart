...
class _ContainerScreen extends State<ContainerScreen> {
  ...
  setCurrency() async {
    ...
    await FireStoreUtils.firestore
        ...
        .then((value) {
      setState(() {
        minimumDepositToRideAccept = value.data() != null
            ? value.data()!['minimumDepositToRideAccept'] == null
                ? ''
                : value.data()!['minimumDepositToRideAccept']
            : '';
        driverLocationUpdate = value.data() != null
            ? value.data()!['driverLocationUpdate'] == null
                ? ''
                : value.data()!['driverLocationUpdate']
            : '';
        singleOrderReceive = value.data() != null
            ? value.data()!['singleOrderReceive'] == null
                ? false
                : value.data()!['singleOrderReceive']
            : false;
        mapType = value.data() != null
            ? value.data()!['mapType'] == null
                ? ''
                : value.data()!['mapType']
            : '';
      });
    ...
    if (permissionStatus == PermissionStatus.granted) {
      ...
      location.changeSettings(
          ...
          distanceFilter: double.parse(
              driverLocationUpdate.isEmpty ? '0' : driverLocationUpdate));
